...
const numbersLessThan50 = crazyNumbers.filter(number => number < 501).length
...
const before2000Movies = tarantinoMovies.filter(movie => movie.release < 2000)
...
const tvShowsNamesOnly = tvShows.map(item => item.name)
